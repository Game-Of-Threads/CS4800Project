...
class Notebook extends Component {
  constructor(props) {
    ...
    /*
    fetch('http://ec2-13-56-253-7.us-west-1.compute.amazonaws.com:5000/api/genericGetCall?getColumn=acc_firstName&table=account&compColumn=acc_id&val=1').then(function(response) {
      return response.json()
    }).then((response) => {
      console.log(response);
    });

    fetch("http://ec2-13-56-253-7.us-west-1.compute.amazonaws.com:5000/api/updateGeneric?table=account&generalCol=acc_firstName&newVal='Mara'&compCol=acc_id&compVal=1").then(function(response) {}).then((response) => {});
    */
